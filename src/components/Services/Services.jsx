...
function ServiceCard({ service, index }) {
  return (
    <div
      ...
      className="service-card-frame services-card-reveal relative w-full"
    >
      <article className="relative z-[1] flex min-h-[552px] w-full min-w-0 flex-col items-center bg-surface px-[34px] pb-9 pt-11 text-center max-[1280px]:min-h-[530px] max-[1280px]:px-[25px] max-[1024px]:min-h-[525px] max-[480px]:min-h-[500px] max-[480px]:px-[22px] max-[480px]:pb-8 max-[480px]:pt-9 max-[360px]:min-h-[480px]">
        <div className="flex h-[162px] w-full items-center justify-center max-[480px]:h-[150px]">
          <img
            src={service.icon}
            alt=""
            aria-hidden="true"
            className="h-[155px] w-auto object-contain transition-transform duration-500 [transition-timing-function:var(--ease-elegant)] group-hover:-translate-y-[7px] max-[480px]:h-[143px] motion-reduce:transform-none motion-reduce:transition-none"
          />
        </div>
  ...
  return (
    ...
    >
      <div className="site-container">
        ...
        <div className="mx-auto mt-[65px] grid grid-cols-3 gap-[34px] max-[1280px]:gap-7 max-[1024px]:mt-14 max-[1024px]:max-w-[880px] max-[1024px]:grid-cols-2 max-[1024px]:gap-7 max-[760px]:mt-12 max-[760px]:max-w-[470px] max-[760px]:grid-cols-1 max-[760px]:gap-7 max-[480px]:mt-[41px] max-[480px]:max-w-[450px] max-[480px]:gap-6">
