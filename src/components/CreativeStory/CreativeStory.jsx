...
export default function CreativeStory() {
  ...
  return (
    <section
      ...
      className={`creative-story-scope w-full overflow-hidden bg-white py-[56px] max-[1280px]:py-[52px] max-[1024px]:py-12 max-[768px]:py-11 max-[480px]:py-9 max-[360px]:py-8 ${
        isVisible ? "is-visible" : ""
      }`}
    >
      <div className="relative isolate h-[clamp(640px,50vw,720px)] w-full overflow-hidden bg-surface max-[1280px]:h-[clamp(610px,54vw,690px)] max-[1050px]:h-[620px] max-[850px]:h-auto max-[850px]:pb-[70px] max-[600px]:pb-[54px]">
        ...
        <article className="creative-story-card absolute right-[9.05%] top-1/2 z-[2] h-[82.3%] w-[min(30.75vw,440px)] bg-white/[0.94] p-[11px] shadow-[0_14px_45px_rgba(74,61,50,0.025)] backdrop-blur-[1px] max-[1280px]:right-[6%] max-[1280px]:h-[82%] max-[1280px]:w-[min(34vw,420px)] max-[1050px]:right-[4%] max-[1050px]:h-[80%] max-[1050px]:w-[40%] max-[1050px]:min-w-[385px] max-[850px]:relative max-[850px]:right-auto max-[850px]:top-auto max-[850px]:mx-auto max-[850px]:mt-[-105px] max-[850px]:h-auto max-[850px]:min-h-[530px] max-[850px]:w-[min(calc(100%_-_70px),590px)] max-[600px]:mt-[-62px] max-[600px]:min-h-[490px] max-[600px]:min-w-0 max-[600px]:w-[calc(100%_-_30px)] max-[600px]:p-2 max-[380px]:mt-[-48px] max-[380px]:min-h-[465px] max-[380px]:w-[calc(100%_-_22px)]">
          <div className="flex h-full w-full flex-col items-center justify-start border border-accent-border px-[34px] pb-[30px] pt-[clamp(25px,2.1vw,31px)] text-center text-body max-[1280px]:px-[30px] max-[850px]:min-h-[508px] max-[850px]:px-[45px] max-[850px]:pb-[38px] max-[850px]:pt-[31px] max-[600px]:min-h-[474px] max-[600px]:px-[22px] max-[600px]:pb-[31px] max-[600px]:pt-[27px] max-[380px]:min-h-[449px] max-[380px]:px-[17px]">
            ...
            >
              Your wedding deserves photographs that feel natural, refined,
              and deeply personal—honest moments preserved with an artistic
